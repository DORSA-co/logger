...
class logger:
    ...
    def set_current_user(self, current_username):
    ...
    def create_new_log(self, message, level):
        ...
        # do log by levels
        # debug
        line_seperator = self.line_seperator * 80
...
if __name__ == "__main__":
    ...
    l.create_new_log('Test1', level=log_levels.DEBUG)
    ...
    l.create_new_log('Test3', level=log_levels.DEBUG)
